...
import { validateSocialLink } from '../../../../lib/validations';

export default async function handler(req, res) {
  if (req.method === 'GET') {
    try {
      const data = await prisma.socialLink.findMany({ orderBy: { createdAt: 'desc' } });
  ...
  if (req.method === 'POST') {
    ...
    const validationError = validateSocialLink(req.body);
