...
import { validateIndustry } from '../../../../lib/validations';

export default async function handler(req, res) {
  if (req.method === 'GET') {
    try {
      const data = await prisma.industry.findMany({ orderBy: { order: 'asc' } });
  ...
  if (req.method === 'POST') {
    ...
    const validationError = validateIndustry(req.body);
