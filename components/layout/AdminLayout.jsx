...
export default function AdminLayout({ children }) {
  ...
  return (
    <div className="flex h-screen font-sans overflow-hidden bg-gradient-to-r from-[#833ab4] via-[#fd1d1d] to-[#fcb045]">
      ...
      {/* Mobile Top Bar */}
      <div className="md:hidden fixed top-0 left-0 right-0 h-16 bg-white/85 backdrop-blur-xl border-b border-white/50 shadow-md text-gray-900 flex items-center justify-between px-4 z-50">
      ...
      <main className="flex-1 p-4 pt-20 md:p-8 md:pt-8 overflow-y-auto w-full h-full relative">
        <div className="max-w-5xl mx-auto rounded-xl bg-white/85 backdrop-blur-xl border border-white/50 shadow-2xl text-gray-900 p-4 md:p-8 min-h-full">
          {children}
        </div>
      </main>
    </div>
