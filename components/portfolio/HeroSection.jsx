...
export default function HeroSection({ profile }) {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center pt-[60px] pb-10 sm:pt-20 sm:pb-0 overflow-hidden bg-transparent">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        ...
        >
          <span className="inline-block py-1 px-4 rounded-full bg-[#111111]  text-white text-sm font-heading font-bold tracking-wider tracking-widest mb-8 border border-[#333] shadow-sm uppercase">
            Available for Work
          </span>
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
            <a 
              href="#contact" 
              className="px-8 py-4 bg-[#ff5a1f] hover:bg-[#e04d19] text-white rounded-xl font-heading font-bold tracking-wider uppercase tracking-wide transition-all shadow-[0_0_40px_-10px_rgba(255,90,31,0.5)] hover:shadow-[0_0_60px_-15px_rgba(255,90,31,0.7)] flex items-center gap-2"
            >
            ...
            <a 
              ...
              className="px-8 py-4 bg-[#111111] hover:bg-[#111111] text-white rounded-xl font-heading font-bold tracking-wider uppercase tracking-wide transition-all border border-[#333]  shadow-xl flex items-center gap-2"
            >
